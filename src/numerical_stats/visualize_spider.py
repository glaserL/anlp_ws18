...
def make_spider(ind, title, color):
    ...
    if ind == 0:
        ax.set_ylabel(r'\textbf{Country}', labelpad = 35, fontsize = 12)
    elif ind == 3:
        ax.set_ylabel(r'\textbf{Pop}', labelpad = 35, fontsize = 12)
    elif ind == 6:
        ax.set_ylabel(r'\textbf{Hip-Hop}',labelpad = 35, fontsize = 12)
