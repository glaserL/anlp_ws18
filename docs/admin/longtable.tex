...
\begin{ThreePartTable}
	...
	\begin{tabular}{L{1.5cm} L{2cm} L{1.5cm} L{2cm} L{2cm} p{1.5cm} p{1.5cm} p{1.5cm} p{0.1cm} p{1.5cm} p{1.5cm} p{1.5cm}}
		...
		\midrule[0.35mm]\\[-0.4cm]
		 ...
		 \multirow{1}{*}{Pop}&\multirow{1}{*}{2272}&AWL&12.925& \textbf{2.50e-06}& 3.884&\textbf{5.22e-05}& 0.1152&& 0.916&1.80e-01& 0.02718\\
		...
		\multirow{1}{*}{Hip-Hop}&\multirow{1}{*}{4835}&AWL&109.494& \textbf{6.35e-48}& 5.786&\textbf{3.72e-09}& 0.1177&& 8.973&\textbf{1.71e-19}& 0.18250\\
